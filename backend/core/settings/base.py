...
SPECTACULAR_SETTINGS = {
    'TITLE': 'NextCRM API',
    'DESCRIPTION': 'Commodity Trading CRM System API',
    'VERSION': '1.0.0',
    ...
    'TAGS': [
        ...
        {'name': 'Counterparties', 'description': 'Counterparty CRM operations'},
        {'name': 'Commodities', 'description': 'Commodity catalog management'},
        {'name': 'Dashboard', 'description': 'Dashboard analytics and KPIs'},
    ],
}
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'nextcrm.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
